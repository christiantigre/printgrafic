...
<head>
    ...
    <title>.: @yield('tittle','PrintGrafic') :.</title>

    <!-- Bootstrap core CSS -->
    <link href="{{ asset('/css/bootstrap.css') }}" rel="stylesheet">
    <!--Print grafic Bootstrap core CSS -->
    <link href="{{ asset('printgrafic/css/main.css') }}" rel="stylesheet">
    ...
    <script src="{{ asset('printgrafic/js/printgrafic.js') }}"></script>
    ...
    <div id="navigation" class="navbar navbar-default navbar-fixed-top">
        ...
        <!--<div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><b>PrintGrafic</b></a>
            </div>
            <div class="navbar-collapse collapse">
                <div class="row">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="active"><a href="#home" class="smoothScroll">Inicio</a></li>
                        <li><a href="#desc" class="smoothScroll">Productos</a></li>
                        <li><a href="#showcase" class="smoothScroll">Catálogo</a></li>
                        <li><a href="#showcase" class="smoothScroll">Portafolio</a></li>
                        <li><a href="#contact" class="smoothScroll">PrintGráfic</a></li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right">
                        @if (Auth::guest())
